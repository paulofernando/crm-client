                ...
                >
                  {({
                    ...
                    <FORM onSubmit={handleSubmit} className="mx-auto">
                      ...
                      >
                        ...
                        <InputGroup>
                          ...
                          <Form.Control
                            ...
                            value={values.value}
                            className={
                              touched.value && errors.value ? "error" : null
                            }
                      ...
                      <div style={{display: withContactForm ? 'hidden' : 'none'}}>
                        <h3 className="m-3" style={{textAlign: 'center'}}>Create Contact</h3>
                        <PartialContactForm
                          values={values}
                          errors={errors}
                          touched={touched}
